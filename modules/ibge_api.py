...
def _buscar_renda_media(codigo_ibge: str) -> dict:
    ...
    return {"valor": valor, "fonte": "IBGE SIDRA"}
...
def _buscar_escolaridade(codigo_ibge: str) -> dict:
    ...
    return {"valor": max(0.0, min(1.0, valor / 100 if valor > 1 else valor)), "fonte": "IBGE SIDRA"}
...
def _buscar_crescimento_populacional(codigo_ibge: str) -> dict:
    ...
    return {
        "valor": (pop_2022 - pop_2010) / pop_2010,
        "pop_2010": pop_2010,
        "pop_2022": pop_2022,
        "fonte": "IBGE SIDRA",
    }
...
def _buscar_idh(codigo_ibge: str) -> dict:
    return {"valor": MEDIANAS_NACIONAIS["idh"], "fonte": "estimativa"}


def _fallback_por_variavel(nome: str) -> dict:
    mapa = {
        "renda_media_domiciliar": {"valor": MEDIANAS_NACIONAIS["renda_media_domiciliar"], "fonte": "estimativa"},
        "idh": {"valor": MEDIANAS_NACIONAIS["idh"], "fonte": "estimativa"},
        ...
        "escolaridade": {"valor": MEDIANAS_NACIONAIS["escolaridade_superior"], "fonte": "estimativa"},
        "densidade_populacional": {"valor": MEDIANAS_NACIONAIS["densidade_populacional"], "fonte": "estimativa"},
        "proporcao_alugados": {"valor": MEDIANAS_NACIONAIS["proporcao_alugados"], "fonte": "estimativa"},
        "crescimento_populacional": {
            "valor": MEDIANAS_NACIONAIS["crescimento_populacional"],
            "pop_2010": None,
            "pop_2022": None,
            "fonte": "estimativa",
        },
